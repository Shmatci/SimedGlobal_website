...
const Table = () => {
  return (
    <>
      <Seo pageTitle="Parameters" />
      <DefaulHeader />
      <div className="pt-100 pb-50 lg-pb-10 md-pt-10 parameter-bckg">
        <div className={homeStyles.cla}>
          <Link href="../ttt/poc" className="pt-10 pb-20">
            &laquo; POC
          </Link>
          <h1 className="table_heading text-center">Parameters</h1>
          <table className="table">
            ...
            <tr>
              ...
              <td>
                IgM: 0.01~10.00mIU/mL
                <br />
                IgG: 0.01~10.00mIU/mL
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>LS-1100/LS-2100/LS-4000</td>
              <td>
                cTnl: 0.1ng/mL～40ng/mL
                <br />
                CK-MB: 2ng/mL～80ng/mL
                <br />
                Myo: 20ng/mL～500ng/mL
              </td>
            </tr>
            <tr>
              <td>D-Dimer</td>
            ...
            <tr>
              <td colspan="3">
                S: Serum | P: Plasma | WB: Whole blood | C: Capillary blood
              </td>
            </tr>
          </table>
        </div>
